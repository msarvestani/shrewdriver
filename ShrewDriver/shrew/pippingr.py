...
def load_parameters(task):
    print "Using settings for pippingr!"
    ...
    task.sPlusOrientations = [45, 90, 135, 180]
    ...
    task.catchChance = 0.9
    task.rewardDelay = 1.0

    task.hintChance = 0.6  # chance of sending a low reward at the start of the reward period
