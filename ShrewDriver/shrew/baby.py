...
def load_parameters(task):
    ...
    task.sPlusOrientations = [60]
    task.sMinusOrientations = [40] # [40]
    ...
    task.airPuffMode = AirPuffMode.FALSE_ALARM_LICK #AirPuffMode.BAD_DISCRIM #AirPuffMode.FALSE_ALARM_LICK #AirPuffMode.NONE
    ...
    # Rewards / Hints
    task.rewardBolus = 75  # Microliters
    task.rewardBolusHardTrial = 100  # Microliters
    task.hintBolus = 25  # Microliters
    ...
    task.commandStrings[States.SMINUS] = 'as sf0.25 tf0 jf0 ja0 gc.9 px0 py0 sx999 sy999\n'
    task.commandStrings[States.GRAY] = 'sx0 sy0\n'
    task.commandStrings[States.SPLUS] = 'as sf0.25 tf0 jf0 ja0 gc.9 px0 py0 sx999 sy999\n'
