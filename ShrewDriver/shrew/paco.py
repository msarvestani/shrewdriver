...
def load_parameters(task):
    ...
    #task.sMinusOrientations = [112.5, 125, 90]  # [40]
    task.sMinusOrientations = [112.5, 90]  # [40]
    ...
    task.airPuffMode = AirPuffMode.NONE #AirPuffMode.FALSE_ALARM_LICK #AirPuffMode.BAD_DISCRIM #AirPuffMode.FALSE_ALARM_LICK #AirPuffMode.NONE
    ...
    task.rewardBolusHardTrial = 20  # Microliters
    task.hintBolus = 20  # Microliters

    task.hintChance = .01# chance of sending a low reward at the start of the reward period
    ...
    task.commandStrings[States.SMINUS] = 'acgf sf0.25 tf0 jf0 ja0 gc0.9 px0 py0 sx40 sy40\n'
    task.commandStrings[States.GRAY] = 'sx0 sy0\n'
    #task.commandStrings[States.SPLUS] = 'as sf0.25 tf0 jf0 ja0 gc0.9 px0 py0 sx999 sy999\n'
    task.commandStrings[States.SPLUS] = 'acgf sf0.25 tf0 jf0 ja0 gc0.9 px0 py0 sx40 sy40\n'
    ...
    task.powerLevels = [0,2] #[0, 1, 4, 16]  # mW/mm2
