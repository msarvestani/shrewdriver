...
def load_parameters(task):
    print "Using settings for Tribble-2AFC!"
    ...
    task.boundary = int(90)
    task.deviations = [5, 10, 22.5, 45]
    ...
    task.initiation = Initiation.AUTO
    ...
    if not task.useMovie:
        ...
        task.initTime = 0
        task.variableDelayMin = 0
        task.variableDelayMax = 0
        task.grayDuration = 0.01
