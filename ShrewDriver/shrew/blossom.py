...
def load_parameters(task):
    print "Using settings for blossom!"
    ...
    #task.sPlusOrientations = [45, 90, 135, 180] #Blossom acclimation
    #task.sMinusOrientations = [67.5, 90, 135] # [40]
    #task.sMinusOrientations = [55, 67.5, 90]  # [40]
    #task.sMinusOrientations = [90]
    task.sMinusOrientations = [ 0 ] #180 included for coarse 112.5 for fine
    ...
    task.catchChance = 1.0
    task.rewardDelay = 0

    task.hintChance = 0.3  # chance of sending a low reward at the start of the reward period
